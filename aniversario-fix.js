...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function adicionarEventosClique() {
        ...
        nomes.forEach(nome => {
            ...
            nome.setAttribute(
                'onclick',
                'celebrarAniversario(this.textContent.trim()); return false;'
            );
    ...
    setInterval(() => {
        ...
        if (novosElementos) {
            console.log(
                `Verificação periódica: ${Object.keys(eventosAdicionados).length} nomes de aniversariantes configurados`
            );
        }
    }, 5000);
