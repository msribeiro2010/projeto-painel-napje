...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const newColorOptions = [
        ...
        { className: 'solid-green', color: '#38a169', name: 'Verde Sólido' },
        {
            ...
            color: 'linear-gradient(45deg, #2d3748 25%, transparent 25%, transparent 50%, #2d3748 50%, #2d3748 75%, transparent 75%, transparent)',
            name: 'Listras'
        },
        {
            className: 'pattern-dots',
            color: 'radial-gradient(#3182ce 15%, transparent 16%)',
            name: 'Pontos'
        },
        {
            className: 'pattern-checkered',
            color: 'linear-gradient(45deg, #e53e3e 25%, transparent 25%, transparent 50%, #e53e3e 50%, #e53e3e 75%, transparent 75%, transparent)',
            name: 'Quadriculado'
        }
    ];
